    ...
    <div className={`poke-card-container ${colorName + "-card-container"}`}>
      ...
      <div className="poke-card-row-wrapper">
        <div className="poke-card-field-title-wrapper">
          <span className="poke-card-field-title poke-card-field-title-left">
            Base Happiness
          </span>
          <span className="poke-card-field-title poke-card-field-title-right">
            Capture Rate
          </span>
        </div>
